    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="car-manage">
                ...
                <a href="<?= ROOT_URL . 'admin/add-car.php?user_id=' . $_SESSION['user_id']; ?>" class="btn btn-primary">Ajouter une voiture</a>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($cars as $car) : ?>
                            <tr>
                                <td><img src="<?= ROOT_URL . 'admin/assets/images/' . $car['image']; ?>" alt="Image de voiture" style="max-height: 40px;"></td>
                                <td><?= $car['name']; ?></td>
                                <td><?= $car['price']; ?> €</td>
                                <td><?= $car['year']; ?></td>
                                ...
                                <td>
                                    ...
                                    ?>
                                    <a href="<?= ROOT_URL . 'admin/add-feature.php?car_id=' . $car['id']; ?>" class="btn btn-primary btn-sm">Ajouter une option</a>
                                </td>
                                <td>
