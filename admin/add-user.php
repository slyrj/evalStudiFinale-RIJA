...
<div class="row">
    <div class="col-md-12">
        ...
        <form action="add-user-logic.php" enctype="multipart/form-data" method="POST">
            ...
            <div class="mb-3">
                <label for="createpassword" class="form-label">Valeur</label>
                <input type="text" value="" name="createpassword" class="form-control" required>
            </div>
            <div class="mb-3">
                <label for="confirmpassword" class="form-label">Valeur</label>
                <input type="text" value="" name="confirmpassword" class="form-control" required>
            </div>
            <div class="mb-3">
